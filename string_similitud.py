...
# Este script espera ustede le pase un archivo csv con una soloa columna
#sin titulo y dentro de cada fila debe colocar la descripcion de lo que queire comparar
